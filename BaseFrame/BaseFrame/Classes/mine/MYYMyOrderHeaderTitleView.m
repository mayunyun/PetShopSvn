...
- (void)addSeparatorView
{
    ...
    lineView.frame = CGRectMake(0, 39, mScreenWidth/4, 1);
...
{
    UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(0, 0, mScreenWidth/4, 39)];
...
- (void)wanerSelected:(NSInteger)tagIndex
{
    ...
    [UIView animateWithDuration:0.4 animations:^{
        ...
        self.selectedView.transform = CGAffineTransformMakeTranslation((btn.tag) * mScreenWidth/4, 0);
    }];
